"""
Django settings for first_homepage project.
...
SECRET_KEY = 'django-insecure-*pc$fm7^j&b&+lr3z16u!scb#!ms$9wlkf$ey820i#=wdf#89j'
...
WSGI_APPLICATION = 'first_homepage.wsgi.application'
